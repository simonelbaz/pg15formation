...
\begin{itemize}
   ...
   \item L'\textbf{autovacuum} est déclenché lorsque $\textbf{autovacuum\_freeze\_max\_age} - \textbf{vacuum\_freeze\_min\_age}$ est positif. Ceci même si l'autovacuum n'est pas activé.
